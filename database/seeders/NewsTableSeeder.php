...
class NewsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $news1->created_at = new Carbon('2022-05-10 00:00:00');

        $news1Author = User::find(1);
        ...
        $news2->contents = 'Sección 1.10.33 de "de Finibus Bonorum et Malorum", escrito por Cicero en el 45 antes de Cristo
        ...
        $news2->created_at = new Carbon('2022-04-23 00:00:00');

        $news2Author = User::find(1);
